        ...
        <ul className="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left mt-5">
          <li className="mr-3 flex-1">
            ...
            >
              ...
              <span className="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Home</span>
            </Link>
          </li>
          <li className="mr-3 flex-1">
            <Link
            ...
            >
              ...
              <span className="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Blogs</span>
            </Link>
          </li>
          <li className="mr-3 flex-1">
            <Link
